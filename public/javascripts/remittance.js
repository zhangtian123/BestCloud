				...
				for(var o in DATA)
				{
					...
					$.each(result,function(key,value){
						...
						if(flag1>=currentlist && flag<3)
						{
							...
							Inner(value.BILLNO,value.BILLID,value.CURRENCY,value.TOTALAMOUNT,value.CUSTOMER,value.BILLDATE,value.LASTDATE,value.PAYTYPE,value.BRANCHCODE,value.BANKADDRESS,oDiv);
							aDiv.append(oDiv);
							flag++;
						}
...
var Inner = function(id, billid,currency, money, deal, submittime, latesttime, way, branch, account, oDiv){
	oDiv.innerHTML=oDiv.innerHTML+
				...
				'<!--页眉，放置标题-->'+
				'<div class="mui-card-header">请款单编号：'+id+'</div>'+
