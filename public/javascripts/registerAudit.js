$('body').on("tap",'#UpdateCon',function(){
...
var Inner = function(usercode, company,companycn, date, regaddress, regaddressen, taxnumber, email, billid, billcode, oDiv){
	oDiv.innerHTML = oDiv.innerHTML +
			...
			'<div class="mui-card-header">'+
				'<span class="left-text">用户名</span><span class="a-little-left">'+(usercode==null?'':usercode)+'</span>'+
				'<span class="pointer" style="float:right" id="registerDetail">查看详情></span>'+
